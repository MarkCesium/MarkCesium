...
- I design and develop API services from architecture through to production
- Main stack: **Python** (FastAPI, Django) + **PostgreSQL, Redis**
- Microservices, event-driven architecture (RabbitMQ, NATS, Kafka), gRPC
- Analytics infrastructure: PostHog, Branch.io, Amplitude
...
**Thank you** for visiting my profile! If you're interested in **collaborating** or **hiring**, feel free to reach out via the contacts above.
